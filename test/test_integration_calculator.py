...
def test_addition_operator(page, browser):
...
def test_subtraction_operator(page, browser):
    calculator_page = CalculatorPage(page)
    calculator_page.navigate()
    calculator_page.fill_first_number("20")
...
def test_division_operator(page, browser):
    calculator_page = CalculatorPage(page)
    calculator_page.navigate()
    calculator_page.fill_first_number("20")
...
def test_multiplication_operator(page, browser):
    calculator_page = CalculatorPage(page)
    calculator_page.navigate()
    calculator_page.fill_first_number("20")
...
def test_modulo_operator(page, browser):
    calculator_page = CalculatorPage(page)
    calculator_page.navigate()
